...
Map<String, String> buildAnisetteHeaders({
...
Map<String, String> buildAnisetteProvisioningHeaders(AnisetteState state) => {
...
String anisetteLocalUserIdHash(String localUserUid) {
