...
//
// Mirrors the real class's shape closely enough for the patcher's
// superclass-methodref lookup to resolve
// `KonanPropertiesLoader.getDependencies()Ljava/util/List;`.
//
// Constant-pool layout (1-indexed):
//   1  UTF8 "Code"
//   2  UTF8 "org/jetbrains/kotlin/konan/target/AppleConfigurablesImpl"
//   3  Class(2)
//   4  UTF8 "org/jetbrains/kotlin/konan/properties/KonanPropertiesLoader"
//   5  Class(4)                    ← this class's superclass
...
//  10  UTF8 "emptyList"
//  11  NameAndType(10,7)
//  12  Methodref(9,11)             ← CollectionsKt.emptyList (stand-in for
//                                    the real InternalServer-list branch,
//                                    unused after the fix but kept to mirror
//                                    the real jar's constant pool shape)
//  13  UTF8 "listOf"
//  14  NameAndType(6,7)            ← (getDependencies, ()Ljava/util/List;)
...
Uint8List buildFakeAppleConfigurablesImplClass() {
  final cpEntries = [
    ...
    cpClass(2), // 3
    cpUtf8('org/jetbrains/kotlin/konan/properties/KonanPropertiesLoader'), // 4
    cpClass(4), // 5
  ...
  return Uint8List.fromList([
    ...
    ...u2(5), // super = KonanPropertiesLoader
    ...u2(0), // interfaces
    ...u2(0), // fields
    ...u2(1), // 1 method
    ...member(
