...
Object? parseJsonc(String source) => jsonDecode(stripJsonc(source));

bool jsonDeepEqual(Object? a, Object? b) {
  if (identical(a, b)) return true;
  if (a is Map && b is Map) {
    if (a.length != b.length) return false;
    for (final key in a.keys) {
      if (!b.containsKey(key) || !jsonDeepEqual(a[key], b[key])) return false;
    }
    return true;
  }
...
Map<String, Object?> mergeSettingsDoc(Map<String, Object?>? existing) {
